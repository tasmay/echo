        ...
        <>
         {
          ...
          :
            url ? <iframe className="w-full h-full" src={url} title="pdfviewer" /> 
            :
            <div className='flex w-full h-full items-center justify-center'>
                <p className="text-xs text-gray-500 font-inter font-light">Select a file from the sidebar to view here.</p>
            </div>
         }        
        </>
    </div>
